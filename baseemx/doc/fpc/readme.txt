...
This package contains a freeware 32-bit pascal compiler for Intel 80386 and
compatibles as well as for Motorola 68020 and compatibles. The language
...
****************************************************************************
* Requirements (Motorola version)
****************************************************************************

68020 or compatible processor
Amiga Classic:
 - AmigaOS 2.0.4
 - 8 Mbytes of RAM 
 - hard disk with free space of at least 8 MB
...
common files in dos108.zip, w32108.zip and os2108.zip:
------------------------------------------------------------
...
for the GO32v2, Win32, OS/2 and Linux versions of the compiler/rtl.
